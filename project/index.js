...
var search = {
  FontSize: /(FontSize)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)/,
  Line: /(Line)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(rgba\s*\(\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\)|[a-z]+)/,
  Circle: /(Circle)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(rgba\s*\(\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\)|[a-z]+)\s+(rgba\s*\(\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\)|[a-z]+)/,
  Rect: /(Rect)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(\d*[\.]?\d*)\s+(rgba\s*\(\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\)|[a-z]+)\s+(rgba\s*\(\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\,\s*\d+[\.]?\d*\s*\)|[a-z]+)/,
};
